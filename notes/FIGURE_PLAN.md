...
- **1c non-vacuity** (bottom-right): R²(L|P) — flexible learner recovers ~0.30 (both models) → ~70% irreducible. Bars with CI, ref line at "P determines L" (R²=1) vs "irreducible" (0). Source `r2_leverage_from_P.csv`. [UPडATED from the old TV-matched 47/79 — that was peakedness-confounded.]
